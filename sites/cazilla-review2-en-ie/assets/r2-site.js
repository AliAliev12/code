(function () {
  ...
  var AGE_COOKIE = "cazilla_review2_skin_age_ok";
  var COOKIE_CHOICE = "cazilla_review2_skin_cookie";
  ...
  function syncAgeCopy() {
    ...
    if (ps.length) {
      ps[0].textContent =
        "Under Irish law, remote betting and gaming are restricted to adults aged " +
        minAge +
        " or older (see Revenue Commissioners guidance on licensing and age controls). " +
        "This editorial review site discusses regulated gambling topics for readers in Ireland.";
    }
  }
