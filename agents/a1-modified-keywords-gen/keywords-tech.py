...
ENV_PATH = ROOT / ".env"
INPUT_PATH = Path("./keywords-tech.txt")   # <-- входной файл со списком ключей
...
if site_dir:
    out_path = ROOT / site_dir / "_output" / "keywords-tech.json"
else:
    out_path = ROOT / "agents/a1-keywords/agents/output/keywords-tech.json"
